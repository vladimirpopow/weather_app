class Constants {
  ...
  static const String WEATHER_BASE_IMG_URL_DOMAIN = 'openweathermap.org';
  static const String WEATHER_FORECAST_PATH = '/data/2.5/forecast/daily';
  static const String WEATHER_IMAGE_PATH = '/img/w/';
  static const String WEATHER_IMAGE_URL = WEATHER_BASE_SCHEME + WEATHER_BASE_IMG_URL_DOMAIN + WEATHER_IMAGE_PATH;
}